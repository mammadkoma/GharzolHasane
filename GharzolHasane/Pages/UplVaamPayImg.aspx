<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UplVaamPayImg.aspx.cs" Inherits="GharzolHasane.Pages.UplVaamPayImg" %>
    ...
    <form id="form1" runat="server">
        <div style="direction: rtl">
            <span class="style1"><span class="style3">نکته 1 : حجم تصویر نباید از 500 کیلو بایت بیشتر باشد.</span><br class="style2" />
                ...
                <dx:ASPxUploadControl ID="ASPxUploadVaamPay" runat="server" OnFileUploadComplete="ASPxUploadVaamPay_FileUploadComplete" ShowProgressPanel="True" ShowUploadButton="True" Theme="RedWine" Width="280px">
